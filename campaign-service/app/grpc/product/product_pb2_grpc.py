...
from . import product_pb2 as product_dot_product__pb2
...
class ProductServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CheckAvailability = channel.unary_unary(
                ...
                request_serializer=product_dot_product__pb2.CheckAvailabilityRequest.SerializeToString,
                response_deserializer=product_dot_product__pb2.CheckAvailabilityResponse.FromString,
                )
...
def add_ProductServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CheckAvailability': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=product_dot_product__pb2.CheckAvailabilityRequest.FromString,
                    response_serializer=product_dot_product__pb2.CheckAvailabilityResponse.SerializeToString,
            ),
    }
...
class ProductService(object):
    ...
    def CheckAvailability(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/product.ProductService/CheckAvailability',
            product_dot_product__pb2.CheckAvailabilityRequest.SerializeToString,
            product_dot_product__pb2.CheckAvailabilityResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
